    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer_key', models.CharField(help_text=b'The consumer key that you obtain when you create an app at https://apps.twitter.com/', max_length=150)),
                ('consumer_secret', models.CharField(help_text=b'The consumer secret that you obtain when you create an app at https://apps.twitter.com/', max_length=150)),
                ('access_token', models.CharField(help_text=b"You can generate your user access token at http://apps.twitter.com by clicking 'Create my access token'.", max_length=150)),
                ('access_token_secret', models.CharField(help_text=b"You can generate your user access token secret at http://apps.twitter.com by clicking 'Create my access token'.", max_length=150)),
