...
class Collection(models.Model):
    ...
    consumer_key = models.CharField(max_length=150,help_text="The consumer key that you obtain when you create an app at https://apps.twitter.com/")
    consumer_secret = models.CharField(max_length=150,help_text="The consumer secret that you obtain when you create an app at https://apps.twitter.com/")
    access_token = models.CharField(max_length=150,help_text="You can generate your user access token at http://apps.twitter.com by clicking 'Create my access token'.")
    access_token_secret = models.CharField(max_length=150,help_text="You can generate your user access token secret at http://apps.twitter.com by clicking 'Create my access token'.")
